#ifndef _LIST_GRADER_QUEUE_INCLUDED_
#define _LIST_GRADER_QUEUE_INCLUDED_
...
class list
{
  ...
  public:
    ...
    void concat(list<T> &other) {
      ...
      mSize += other.mSize;
      node* myLast = mHeader->prev;
      mHeader->prev->next = other.mHeader->next;
      mHeader->prev = other.mHeader->prev;
      other.mHeader->prev->next = mHeader;
      other.mHeader->next->prev = myLast;
      
      other.mHeader->next = other.mHeader;
      other.mHeader->prev = other.mHeader;
      other.mSize = 0;
